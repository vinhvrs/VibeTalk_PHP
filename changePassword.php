                    ...
                    <div class="card bg-white mt-5 rounded" id="loginForm">
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                <input type="text" name="oldPassword" placeholder="Old Password" class="form-control mb-3">
                                <input type="password" name="newPassword" placeholder="New Password" class="form-control mb-3">
                                <input type="password" name="confirmPassword" placeholder="Comfirm" class="form-control mb-3">
                                <button class="btn btn-success mt-2" style="position: relative; left: 38%" name="change" >Change Password</button>
                            </form>
                        </div>
                    </div>
                </div>
